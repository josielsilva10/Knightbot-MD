...
exports.generateMessageTag = (epoch) => {
    ...
    if (epoch)
        tag += '.--' + epoch; // anexa epoch se fornecido
    return tag;
}
...
exports.getTime = (format, date) => {
    if (date) {
        ...
        return moment.tz('Asia/Jakarta').locale('pt-br').format(format)
    }
}

exports.formatDate = (n, locale = 'pt-br') => {
    let d = new Date(n)
...
exports.tanggal = (numer) => {
    const myMonths = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"];
    const myDays = ['Domingo', 'Segunda-feira', 'Terça-feira', 'Quarta-feira', 'Quinta-feira', "Sexta-feira", 'Sábado'];
...
exports.logic = (check, inp, out) => {
    if (inp.length !== out.length) throw new Error('Entrada e Saída devem ter o mesmo tamanho')
    for (let i in inp)
