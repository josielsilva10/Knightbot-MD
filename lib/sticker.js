...
/**
 * Imagem/Vídeo para Figurinha
 * @param {Buffer} img Buffer da Imagem/Vídeo
 * @param {String} url URL da Imagem/Vídeo
 * @param {String} packname Nome do Pacote EXIF
 * @param {String} author Autor EXIF
 */
...
/**
 * Converter usando fluent-ffmpeg
 * @param {string} img 
 * @param {string} url 
 */
...
/**
 * Adicionar Metadados JSON Exif do WhatsApp
 * Retirado de https://github.com/pedroslopez/whatsapp-web.js/pull/527/files
...
/**
 * Converter mídia para WebP e adicionar metadados
 * @param {Buffer} inputBuffer Buffer da Imagem
 * @param {String} url URL da Imagem
 * @param {String} packname Nome do Pacote EXIF
 * @param {String} author Autor EXIF
 */
async function sticker(isImage, url, packname, author) {
    try {
        ...
        console.error('Erro na criação da figurinha:', error);
        return null;
    }
}
