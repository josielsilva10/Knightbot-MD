...
exports.fetchBuffer = async (url, options) => {
	try {
		...
		const res = await axios({
			...
			url,
			headers: {
                "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, como Gecko) Chrome/78.0.3904.70 Safari/537.36",
				'DNT': 1,
...
exports.webp2mp4File=async(path) =>{
	return new Promise((resolve, reject) => {
		 ...
		 axios({
			  ...
			  bodyFormThen.append('convert', "Converter WebP para MP4!")
			  axios({
				   method: 'post',
